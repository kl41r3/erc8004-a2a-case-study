...
下列文字仅是待人工编码、复核和计算完成后使用的模板。当前 CSV 的 human
字段为空，因此本 artifact 不报告人工 gold-standard validity。
...
An independent human coder coded all 50 records following the codebook in
