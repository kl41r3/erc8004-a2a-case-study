...
\texttt{davidecrapis.eth} (Ethereum Foundation). The standard defines a
...
dimension. What differs is the \textit{distribution of named institutional
influence}. Google's 25.0\% record share---the highest single institution in
either case---reveals disproportionate contribution intensity, particularly from
\texttt{holtskinner} (Google, $\approx$560 records, $\approx$10\% of all A2A records).
This is how corporate governance reproduces hierarchy within an ostensibly open
project: not by excluding others, but by having employees who contribute at
orders-of-magnitude higher rates than external participants.

ERC-8004's top institution (MetaMask, 12.6\% of records) is less than half of
Google's A2A share, and MetaMask's contribution intensity was episodic---its
dominance reversed when The Graph's \texttt{pcarranzav} and Hats Protocol's
...
The evidence: MetaMask's 12.6\% record share with only one highly active
contributor shows high institutional intensity but not monopoly, and
institutional dominance did not suppress the Oppose voices from The Graph
and Hats Protocol that forced specification revisions. Google A2A's TSC gate is the structural opposite:
